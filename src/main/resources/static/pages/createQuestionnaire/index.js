onload = () => {
  ...
  $('#NewProjectName').html('<span>'+window.sessionStorage.getItem("createQuestionnaireProjectName")+'</span>')
}

const onCreateTemplate = () => {
  window.sessionStorage.setItem('newQuestionnaireId',sessionStorage.getItem("createQuestionnaireProjectId"))
  window.sessionStorage.setItem('newQuestionnaireType',$('#selectLeo').val())
