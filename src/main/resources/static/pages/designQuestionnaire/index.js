...
const onAddQuestion = (type) => {
  ...
  $('#problem').append(ele)
  problem.push({ problemName: '', mustAnswer: true, problemType: type ,option: [{}] })
...
const handleEditFinish = () => {
  let questionnaireId = window.sessionStorage.getItem("currentQuestionnaireId");
  console.log(problem)
  $.ajax({
    url: '/questionnaire/modifyQuestionnaire/'+questionnaireId,
    type: "POST",
