          ...
          <div class="list">
            <div class="list-header">
              ...
              <div>
                ...
                <button type="button" class="btn btn-link" onclick="onStatisticsProject('${item.id}','${item.projectName}')">统计</button>
              </div>
            </div>
...
const onCreateQuestionnaire = (id,projectName) => {
  window.sessionStorage.setItem("createQuestionnaireProjectId",id)
  window.sessionStorage.setItem("createQuestionnaireProjectName",projectName)
  location.href = "/pages/createQuestionnaire/index.html"
}

const onSeeProject = (id) => {
  $util.setPageParam('seeProjectId', id)

  sessionStorage.setItem('seeProject', id)
...
const onStatisticsProject = (id,projectName)=>{
  window.sessionStorage.setItem("createQuestionnaireProjectId",id)
  window.sessionStorage.setItem("createQuestionnaireProjectName",projectName)
  location.href = "/pages/staticsOfProject/index.html"
}
